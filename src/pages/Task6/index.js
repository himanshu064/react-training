...
const TodoContextState = (props) => {
  ...
  const showAllComletedTasks = () => {
    ...
    return (
    <TodoContext.Provider value={{allTasks,updateTask,deleteTask,completeAll,deleteoneTask,completedTask,showAllTasks,showAllActiveTasks,showAllComletedTasks}}>
      {props.children}
